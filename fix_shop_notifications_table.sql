-- =====================================================
-- Fix Missing shop_notifications Table
...
DROP POLICY IF EXISTS "Shop owners can view their notifications" ON shop_notifications;
DROP POLICY IF EXISTS "Anyone can create notifications" ON shop_notifications;
DROP POLICY IF EXISTS "Authenticated users can create notifications" ON shop_notifications;
DROP POLICY IF EXISTS "Shop owners can update their notifications" ON shop_notifications;
...
-- Done! This will fix the 404 error for shop_notifications.
