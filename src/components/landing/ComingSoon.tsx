export default function ComingSoon() {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-modern-blue/10 to-modern-purple/10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {upcoming.map((feature, index) => (
            <div 
              key={index}
              className="bg-white rounded-modern p-8 shadow-modern-lg"
            >
              <div className="text-5xl mb-4">{feature.icon}</div>
              <div className="inline-block bg-modern-blue/20 text-modern-blue px-3 py-1 rounded-full text-sm font-semibold mb-4">
                {feature.timing}
              </div>
