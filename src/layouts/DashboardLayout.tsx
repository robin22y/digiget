            ...
            >
              ...
              <nav className="px-3 py-4 space-y-1 bg-white">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center px-4 py-3 text-sm font-medium rounded-modern transition-all duration-200 text-modern-blue hover:bg-system-bg border-t border-system-separator"
                >
                  <Clock className="w-5 h-5 mr-3" />
                  Staff Clock In/Out Console
                </a>
